...
var $author$project$Main$Advent = F2(
	function (a, b) {
		return {$: 'Advent', a: a, b: b};
	});
...
var $author$project$Main$Christmas = function (a) {
	return {$: 'Christmas', a: a};
};
...
var $author$project$Main$initDay = F2(
	function (zone, time) {
		...
		if (month.$ === 'Dec') {
			...
			return (day > 23) ? $author$project$Main$Christmas(
				$author$project$Main$Year(year)) : A2(
				$author$project$Main$Advent,
				$author$project$Main$Year(year),
				day);
		} else {
...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{
			openSlots: $elm$core$Set$empty,
			today: A2(
				$author$project$Main$Advent,
				$author$project$Main$Year(2025),
				12)
		},
...
var $author$project$Main$update = F2(
	function (msg, model) {
		if (msg.$ === 'ToggleGiftSlotOpen') {
			var num = msg.a;
			var transform = A2($elm$core$Set$member, num, model.openSlots) ? $elm$core$Set$remove : $elm$core$Set$insert;
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						openSlots: A2(transform, num, model.openSlots)
					}),
				$elm$core$Platform$Cmd$none);
		} else {
			var day = msg.a;
...
var $author$project$Main$toYear = function (day) {
	switch (day.$) {
		case 'Advent':
			var y = day.a.a;
...
var $author$project$Main$viewHeader = function (day) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('w-full sm:h-[16vmin] text-center tex-white')
			]),
		_List_fromArray(
			[
				$elm$html$Html$text(
				A2(
					...
					A2(
						$elm$core$Maybe$map,
						function (year) {
							return 'Advent ' + $elm$core$String$fromInt(year);
						},
						$author$project$Main$toYear(day))))
			]));
};
var $author$project$Main$view = function (_v0) {
	var today = _v0.today;
	var openSlots = _v0.openSlots;
	...
	return A2(
		...
		A2(
			$elm$core$List$cons,
			$author$project$Main$viewHeader(today),
			A2(
				$elm$core$List$cons,
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"GotDay":["Main.Day"],"ToggleGiftSlotOpen":["Basics.Int"]}},"Main.Day":{"args":[],"tags":{"Advent":["Main.Year","Basics.Int"],"Christmas":["Main.Year"],"Other":["Main.Year"],"Unset":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Main.Year":{"args":[],"tags":{"Year":["Basics.Int"]}}}}})}});}(this));